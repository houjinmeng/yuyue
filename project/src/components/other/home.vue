<template>
  <div class="app">
    ...
    <div style='text-align:center;color:#666666;font-size:0.2rem;margin-bottom:0.2rem'>您的系统权限是:</div>
    <div style="text-align:center;font-size:0.3rem;color:#dfb065">{{rule_name}}</div>
