<template>
  <div>
    ...
    <div class="cards">
      ...
      <div class="bot">
        <div>进场日期 &nbsp&nbsp&nbsp {{list.time*1000|formatDate}}</div>
        <div>进场时间 &nbsp&nbsp&nbsp {{list.time*1000|formatDateTwo}}</div>
    ...
    <div class="cards">
      ...
      <div class="bot">
        ...
        <div>送货时间 &nbsp&nbsp&nbsp {{list.time*1000|formatDate}} {{list.time*1000|formatDateTwo}}</div>
